...
define("SQL_HOST", "ppdc.startlogicmysql.com");
define("SQL_USER", "adekunle");
define("SQL_PASS", "love4lovelace");
define("SQL_DB", "amebo_new");


define("DB_DRIVER", "mysqli"); /// other driver values include mysql, pdo, mongodb
define("ABS_PATH", "http://localhost/php_kurise/");
define("FILE_ROOT", "/public_html/amebo/"); /// file root for for file upload functionalities
